...
public class Analyze 
{
	...
	public static void main(String[] args) 
	{
		...
		OR00014.addPrecip(DBconnection.getAvgPrecip(resKeyOR, DBconnection.getYear(resKeyOR)));
		OR00014.addTemp(DBconnection.getAvgTemp(resKeyOR, DBconnection.getYear(resKeyOR)));
		//OR00014.addLevel(DBconnection.getLevel(resKeyOR));
		OLSMultipleLinearRegression regression=OR00014.linearReg();
