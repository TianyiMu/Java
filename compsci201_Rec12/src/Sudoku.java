...
public class Sudoku {
  /**
   * Solve the board if possible and return true. If the board is not solvable, return false;
  ...
  /**
   * Return [row, col] coordinate of the next open space. If there are no remaining open spaces,
   * return [-1, -1].
   */
  ...
  /**
   * Helper method for isValidBoard
