...
public class HuffMark {
    ...
    private double myTotalUncompressedTimes;
    
    private IHuffProcessor myHuffer;
    private static String SUFFIX = ".hf";
    private static String SUFFIX2 = ".unhf";
    ...
    public void doMark() throws IOException{
        ...
        if (action == JFileChooser.APPROVE_OPTION){
            ...
            dir = ourOpenChooser.getSelectedFile();
            list = dir.listFiles();
            for(File f : list){
                uncompress(f);
            }
            ...
            System.out.printf("uncompression time: %.3f\n", myTotalUncompressedTimes);
        }
    }
    ...
    private String getUnCompressedName(File f){
        ...
        int pos = path.lastIndexOf(name);
        String newName = path.substring(0, pos) + name + SUFFIX2;
        return newName;
    }
